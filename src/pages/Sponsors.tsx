  ...
  const sponsorTiers: Tier[] = [
    ...
    },
    {
      ...
      benefits: [
        ...
        'ارائه کدهای تخفیف و سرورهای رایگان به شرکت‌کنندگان رویداد جهت تست بازی‌ها',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
              با پیوستن به رویداد جهانی بازی‌سازی، برند خود را در کانون توجه هزاران توسعه‌دهنده، طراح و مهندس خلاق نرم‌افزار در ایران قرار دهید و به توسعه صنعت بازی‌سازی مستقل کمک کنید.
            </p>
          </motion.div>
        </div>
      </div>
            ...
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl relative overflow-hidden">
              ...
              <ul className="space-y-3 text-xs text-slate-400">
                <li className="flex gap-2 items-start">
                  ...
                  <span>دسترسی به بااستعدادترین دانش‌آموختگان برنامه‌نویسی و هنری کشور در رویداد</span>
                </li>
                <li className="flex gap-2 items-start">
                  <Check className="w-4 h-4 text-brand-sky shrink-0 mt-0.5" />
