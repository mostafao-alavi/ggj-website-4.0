      ...
      <div className="max-w-7xl mx-auto space-y-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-slate-400 text-sm md:text-base leading-relaxed">
            موزه‌ای دیجیتال از بازی‌های خلاقانه‌ای که جمرهای ایرانی در ماراتن‌های ۴۸ ساعته سال‌های گذشته خلق کرده‌اند. خروجی بازی‌ها را کاوش کنید، آن‌ها را پسند کنید و فایل بازی را مستقیم بارگیری نمایید.
          </p>
        </div>
