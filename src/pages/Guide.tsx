...
const SURVIVAL_RULES = [
  ...
  },
  {
    ...
    unit: 'روزانه و منظم',
    desc: 'سوخت‌رسانی منظم به مغز کلید بقا در ۴۸ ساعت رویداد است. به هیچ عنوان صبحانه یا ناهار را حذف نکنید و از تنقلات بسیار شیرین پرهیز کنید.',
...
const FAQ_DATA: FaqItem[] = [
  {
    question: 'چطور در مدت کوتاه ۴۸ ساعت رویداد تیمی برای بازی‌سازی پیدا کنم؟',
  ...
  {
    question: 'چه نرم‌افزارها و ابزارهایی باید قبل از شروع رویداد روی لپ‌تاپ خود نصب کنیم؟',
      ...
      <div className="max-w-5xl mx-auto space-y-16 relative z-10">
        ...
        <section className="space-y-8">
          <div className="text-center">
            ...
            <p className="text-slate-400 text-xs mt-2 max-w-lg mx-auto">
              سلامتی شما در رویدادهای فشرده فیزیکی خط قرمز ماست. این قانون سه مرحله‌ای تضمین‌کننده خلاقیت پایدار ذهن جمرها در رویداد است.
            </p>
          </div>
        ...
        <section className="space-y-8">
          <div className="text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-black text-white mt-1">بهترین موتورهای بازی‌سازی برای رویداد سرعتی</h2>
            <p className="text-slate-400 text-xs mt-2 max-w-lg mx-auto">
